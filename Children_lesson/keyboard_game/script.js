...
function game_start_reciprocal(){
    ...
    setTimeout(function(){reciprocal.textContent = "555"; music_play('reciprocal_5')}, time[0]);
    ...
    setTimeout(function(){keydown_correct = game_id_rand();}, time[6]);
}
